class FvmAT130Dev4 < Formula
    desc "Simple cli to manage Flutter SDK versions per project"
    homepage "https://github.com/leoafarias/fvm"
    url "https://github.com/leoafarias/fvm/archive/v1.3.0-dev.4.tar.gz"
    sha256 "0da0171cc208ebe53ea71f65dde11ee1a76b254cc9b006c165eb6096437e0cd0"
    license "MIT"
